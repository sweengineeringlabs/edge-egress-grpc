...
use edge_transport_grpc_egress_resilient::{DescribeRequest, ProcessorFactory};
...
/// @covers: create
#[test]
fn test_create_identifies_as_grpc_resilient_error() {
    ...
    assert!(resp.label.contains("resilient"));
}
