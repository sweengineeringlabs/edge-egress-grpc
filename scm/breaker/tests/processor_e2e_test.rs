...
use edge_transport_grpc_egress_breaker::{DescribeRequest, DescribeResponse, Error, Processor};
...
impl Processor for MockProcessor {
    fn describe(&self, _req: DescribeRequest) -> Result<DescribeResponse, Error> {
        if self.fail {
